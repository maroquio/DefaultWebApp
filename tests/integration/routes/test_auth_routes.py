...
class TestCadastro:
    ...
    def test_cadastro_cria_usuario_com_perfil_leitor(self, client):
        """Cadastro público deve criar usuário com perfil LEITOR (Enum Perfil)"""
        ...
        assert usuario.perfil == Perfil.LEITOR.value  # Usa Enum Perfil
